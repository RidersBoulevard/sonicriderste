 ...
 */
ASMDefined void func_ClearPlayerMotionTable(Player *);
ASMDefined void func_GetDirectTrickBonus(Player *, u32);
ASMDefined void func_StartPlayerMotionTable(Player *);
ASMDefined void func__RegistPlayerMotionTable(Player *, u32, u32, f32, f32);
ASMDefined void lbl_0009195C(void *);
ASMDefined void lbl_000FC114(Player *);
ASMDefined void lbl_00187ED0(Player *);
ASMDefined void lbl_Player_BoostEndFunction(Player *playerPtr);
