...
/* 8000312C 0000012C  48 00 BB 51 */	bl OSResetSystem
.global lbl_80003130
lbl_80003130:
...
/* 80003144 00000144  98 0D 84 48 */	stb r0, lbl_8021BD08@sda21(r13)
/* 80003148 00000148  4E 80 00 20 */	blr 

.global func_8000314C
func_8000314C:
/* 8000314C 0000014C  88 6D 84 48 */	lbz r3, lbl_8021BD08@sda21(r13)
...
.global lbl_800031E8
lbl_800031E8:
/* 800031E8 000001E8  3C C0 80 05 */	lis r6, InitMetroTRK@ha
/* 800031EC 000001EC  38 C6 AD 90 */	addi r6, r6, InitMetroTRK@l
...
.global lbl_80003260
lbl_80003260:
/* 80003260 00000260  48 00 EC A9 */	bl DBInit
/* 80003264 00000264  48 00 68 09 */	bl OSInit
...
.global lbl_8000329C
lbl_8000329C:
/* 8000329C 0000029C  48 00 EB D9 */	bl __init_user
/* 800032A0 000002A0  7D C3 73 78 */	mr r3, r14
/* 800032A4 000002A4  7D E4 7B 78 */	mr r4, r15
/* 800032A8 000002A8  48 00 47 A1 */	bl main
/* 800032AC 000002AC  48 03 24 E4 */	b exit
...
/* 80003324 00000324  3C 20 80 22 */	lis r1, __stack_addr@h
/* 80003328 00000328  60 21 CF A8 */	ori r1, r1, __stack_addr@l
...
.weak __flush_cache // libogc already has this function so just default to that one
__flush_cache:
...
/* 8000344C 0000044C  40 80 FF EC */	bge BACKWARD(LOOP)
...
/* 800035A4 000005A4  48 04 58 11 */	bl TRK_fill_mem
...
/* 8000381C 0000081C  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003820 00000820  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003904 00000904  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003908 00000908  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003A04 00000A04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003A08 00000A08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003B04 00000B04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003B08 00000B08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003C04 00000C04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003C08 00000C08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003D04 00000D04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003D08 00000D08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003E04 00000E04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003E08 00000E08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80003F04 00000F04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80003F08 00000F08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004204 00001204  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004208 00001208  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004304 00001304  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004308 00001308  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004404 00001404  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004408 00001408  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004524 00001524  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004528 00001528  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004558 00001558  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 8000455C 0000155C  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004640 00001640  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004644 00001644  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004740 00001740  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004744 00001744  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004840 00001840  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004844 00001844  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004904 00001904  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004908 00001908  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004A04 00001A04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004A08 00001A08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004C04 00001C04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004C08 00001C08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80004D04 00001D04  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80004D08 00001D08  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80005204 00002204  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80005208 00002208  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80005304 00002304  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80005308 00002308  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80005404 00002404  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80005408 00002408  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80005504 00002504  3C 60 80 04 */	lis r3, TRKInterruptHandler@h
/* 80005508 00002508  60 63 8E B8 */	ori r3, r3, TRKInterruptHandler@l
...
/* 80005530 00002530  48 00 97 4D */	bl OSResetSystem
...
_rom_copy_info:
.4byte __init_rom_start__
.4byte __init_rom_start__
.4byte _init_rom_size

.4byte __text_rom_start__
.4byte __text_rom_start__
.4byte _text_rom_size

.4byte __ctors_rom_start__
.4byte __ctors_rom_start__
.4byte _ctors_rom_size

.4byte __dtors_rom_start__
.4byte __dtors_rom_start__
.4byte _dtors_rom_size

.4byte __rodata_rom_start__
.4byte __rodata_rom_start__
.4byte _rodata_rom_size

.4byte __data_rom_start__
.4byte __data_rom_start__
.4byte _data_rom_size

.4byte __sdata_rom_start__
.4byte __sdata_rom_start__
.4byte _sdata_rom_size

.4byte __sdata2_rom_start__
.4byte __sdata2_rom_start__
.4byte _sdata2_rom_size
...
_bss_init_info:
.4byte __bss_rom_start__
.4byte _bss_rom_size

.4byte __sbss_rom_start__
.4byte _sbss_rom_size

.4byte __sbss2_rom_start__
.4byte _sbss2_rom_size

.4byte 0
.4byte 0

.global __init_rom_end__
__init_rom_end__: