...
constexpr GameObject segaCarnival_flyhoop1 =
		{
			ObjectTypes::FlightRing, 0x4, 0x42, 0x8F, 0,
...
constexpr GameObject segaCarnival_flyhoop2 =
		{
			ObjectTypes::FlightRing, 0x4, 0x43, 0x8F, 0,
		 10.9598f, 13.9957f, -264.074f,// coordinates
		 33, 150, -0.395f,             // rotation
		 216, 1, 0};                   // other properties

constexpr GameObject segaCarnival_flyhoop3 =
		{
			ObjectTypes::FlightRing, 0x4, 0x42, 0x8F, 0,
		 -0.443f, 12.0f, -191.14f,// coordinates
		 0, 170, -0.395f,         // rotation
		 216, 1, 0};               // other properties

constexpr GameObject eggFactory_flyhoop1 =
		{
			ObjectTypes::FlightRing, 0x4, 0x44, 0x8F, 0x3C,
...
constexpr GameObject eggFactory_flyhoop2 =
		{
			ObjectTypes::FlightRing, 0x4, 0x44, 0x8F, 0,
...
constexpr GameObject nightChase_car1 =
		{
			ObjectTypes::MetalCityCar, 0x4, 0x4F, 0x1DCF, 0x2,
...
constexpr GameObject darkDesert_itembox1 =
		{
			ObjectTypes::ItemBox, 0x4, 0x45, 0xF, std::to_underlying(ItemID::TenRings),
...
constexpr GameObject babylonGarden_flyhoop1 =
		{
			ObjectTypes::FlightRing, 0x4, 0x41, 0x8F, 0,
...
constexpr GameObject babylonGarden_itembox1 =
		{
			ObjectTypes::ItemBox, 0x4, 0x4F, 0xF, std::to_underlying(ItemID::TenRings),
...
constexpr GameObject digitalDimension_itembox1 =
		{
			ObjectTypes::ItemBox, 0x4, 0x46, 0xF, std::to_underlying(ItemID::HundredAir),
